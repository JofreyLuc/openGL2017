...
void SceneOpenGL::bouclePrincipale()
{
    ...
    float vertices[] = {-50, 0, -50,   50, 0, -50,   50, 0, 50,    // Triangle 1
                        -50, 0, -50,   -50, 0, 50,   50, 0, 50};   // Triangle 2
    ...
    Texture texture("Textures/map.jpg");
    texture.charger();
    ...
    Caisse caisse(1, "Shaders/texture.vert", "Shaders/texture.frag", "Textures/Caisse.jpg");
